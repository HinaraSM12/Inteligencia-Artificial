...
sugerir(Curso) :- 
    ...
    recomendar(Curso, Categoria, Duracion, Costo, _, _,_).

% Base de conocimientos de cursos

% Cursos de Tecnología y Programación
curso('The Ultimate MySQL Bootcamp: Go from SQL Beginner to Expert', tecnologia_programacion, 21.5, 112.475, 'Ingles','udemy', 'https://www.google.com/aclk?sa=l&ai=DChcSEwiH_MXt89mEAxVsqVoFHb__B7AYABAAGgJ2dQ&ase=2&gclid=CjwKCAiA3JCvBhA8EiwA4kujZvqxEb0669lKZaNnQINyP-BO8n8TgG7VsiGcUaWT-21HjgHslfJInBoCPj4QAvD_BwE&sig=AOD64_0T5FM0TbaNDGSnMvYiUXoIBjpygQ&q&nis=4&adurl&ved=2ahUKEwjtsLjt89mEAxUwQjABHVgoBo0Q0Qx6BAgOEAE').
curso('iOS & Swift - The Complete iOS App Development Bootcamp', tecnologia_programacion, 60.5, 69.975, 'Ingles','udemy', 'https://www.udemy.com/course/ios-13-app-development-bootcamp/?utm_source=adwords&utm_medium=udemyads&utm_campaign=iOSDevelopment_v.PROF_la.EN_cc.ROW_ti.6292&utm_content=deal4584&utm_term=_._ag_85479008314_._ad_535397281437_._kw__._de_c_._dm__._pl__._ti_dsa-774930045049_._li_1003665_._pd__._&matchtype=&gad_source=1&gclid=CjwKCAiA3JCvBhA8EiwA4kujZmu7PXI26wflzr3zETGC6MiqISJTUZzyZqDM952ozgt8-kDEB6VafhoCeOwQAvD_BwE&couponCode=2021PM25').
curso('Modern React with Redux [2024 Update]', tecnologia_programacion, 76, 112.475,'Ingles','udemy', 'https://www.udemy.com/course/react-redux/?couponCode=2021PM25').
curso('[NEW] Spring Boot 3, Spring 6 & Hibernate for Beginners', tecnologia_programacion, 34, 87.475,'Ingles', 'udemy', 'https://www.udemy.com/course/learn-flutter-dart-to-build-ios-android-apps/?utm_source=adwords&utm_medium=udemyads&utm_campaign=LongTail_la.EN_cc.ROW&utm_content=deal4584&utm_term=_._ag_77879424134_._ad_535397245863_._kw__._de_c_._dm__._pl__._ti_dsa-1007766171312_._li_1003665_._pd__._&matchtype=&gad_source=1&gclid=CjwKCAiA3JCvBhA8EiwA4kujZmsMwStw3w5paVeS49xugBJbwdRB7hNuk1ylN1sP1DgqnocpDpMwohoC-XMQAvD_BwE&couponCode=2021PM25').
curso('Flutter & Dart - The Complete Guide [2024 Edition]', tecnologia_programacion, 30, 112.475,'Ingles', 'udemy', 'https://www.udemy.com/course/desarrollo-web-completo-con-html5-css3-js-php-y-mysql/?gad_source=1&gclid=CjwKCAiA3JCvBhA8EiwA4kujZix7wdHDC8P2MJxGOhNg3vQIHfpTw_VNVqoSRIT62U52-eLOsuJ8ABoCQDEQAvD_BwE&matchtype=b&utm_campaign=WebDevelopment_v.PROF_la.ES_cc.LATAM&utm_medium=udemyads&utm_source=adwords&utm_term=_._ag_122423571111_._ad_654210014338_._kw_desarrollo+paginas+web_._de_c_._dm__._pl__._ti_kwd-17940653_._li_1003665_._pd__._&couponCode=2021PM25').
curso('The Complete Web Developer Course 3.0', tecnologia_programacion, 31, 87.475, 'Ingles','udemy', 'https://www.udemy.com/course/the-complete-nodejs-developer-course-2/?couponCode=2021PM25').
curso('The Complete Node.js Developer Course (3rd Edition)', tecnologia_programacion, 35, 112.475, 'Ingles','udemy', 'https://www.udemy.com/course/unrealcourse/?utm_source=adwords&utm_medium=udemyads&utm_campaign=LongTail_la.EN_cc.ROW&utm_content=deal4584&utm_term=_._ag_77879424134_._ad_535397245863_._kw__._de_c_._dm__._pl__._ti_dsa-1007766171312_._li_1003665_._pd__._&matchtype=&gad_source=1&gclid=CjwKCAiA3JCvBhA8EiwA4kujZluYE4pJ6HxGXUREhcWQ2B5BTShP6D_fo5I2Yri9jSWP846nYba4tBoCjrIQAvD_BwE').
curso('Unreal Engine 5 C++ Developer: Learn C++ & Make Video Games', tecnologia_programacion, 29.5, 87.475,'Ingles', 'udemy', 'https://www.udemy.com/course/unrealcourse/?utm_source=adwords&utm_medium=udemyads&utm_campaign=LongTail_la.EN_cc.ROW&utm_content=deal4584&utm_term=_._ag_77879424134_._ad_535397245863_._kw__._de_c_._dm__._pl__._ti_dsa-1007766171312_._li_1003665_._pd__._&matchtype=&gad_source=1&gclid=CjwKCAiA3JCvBhA8EiwA4kujZluYE4pJ6HxGXUREhcWQ2B5BTShP6D_fo5I2Yri9jSWP846nYba4tBoCjrIQAvD_BwE').
...
recomendar(Curso, tecnologia_programacion, DuracionMaxima, CostoMaximo,Idioma, Plataforma, Url) :-
    curso(Curso, tecnologia_programacion, Duracion, Costo,Idioma,Plataforma, Url),
    Duracion =< DuracionMaxima,
    Costo =< CostoMaximo,
    write('En este momento te recomiendo el siguiente curso de Tecnología y Programación: '),nl,write(Url), nl.
...
recomendar(Curso, negocios_emprendimiento, DuracionMaxima, CostoMaximo, Idioma,Plataforma, Url) :-
    curso(Curso, negocios_emprendimiento, Duracion, Costo,Idioma, Plataforma,Url),
    Duracion =< DuracionMaxima,
    Costo =< CostoMaximo,
    write('En este momento te recomiendo el siguiente curso de Negocios y Emprendimiento: '),nl,write(Url), nl.
...
recomendar(Curso, idiomas, DuracionMaxima, CostoMaximo, Idioma, Plataforma, Url) :-
    curso(Curso, idiomas, Duracion, Costo,Idioma, Plataforma,Url),
    Duracion =< DuracionMaxima,
    Costo =< CostoMaximo,
    write('En este momento te recomiendo el siguiente curso de Idiomas: '),nl,write(Url), nl.
...
recomendar(Curso, arte_diseno, DuracionMaxima, CostoMaximo, Idioma,Plataforma, Url) :-
    curso(Curso, arte_diseno, Duracion, Costo,Idioma, Plataforma,Url),
    Duracion =< DuracionMaxima,
    Costo =< CostoMaximo,
